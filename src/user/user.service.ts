...
export class UserService {
  ...
  async update(id: number, updateUserDto: UpdateUserDto): Promise<User> {
    //confirm_password vrne error, ker ni v Prismi DB, je pa v frontendu POSTU
    //zato delete-amo v dto predenj klicemo prismo
  ...
  async getUserAuction(id: number): Promise<Auction> {
  ...
  async uploadAuctionImage(auctionId: number, image: string): Promise<Auction> {
  ...
  async changeAuctionStatus(): Promise<void> {
  ...
  async getUserBids(userId: number): Promise<Bid[]> {
    return this.bidService.getAllForUser(userId);
  }
}

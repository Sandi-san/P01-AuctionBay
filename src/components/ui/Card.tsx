  ...
  const getStatusText = () => {
    ...
    if (item.Bid && user) {
      ...
      if (item.Bid?.length > 0 && user.id !== 0) {
        ...
        const highestBid = item.Bid?.reduce(
  ...
  return (
    <>
      <div className="h-[260px] w-[205px] bg-white rounded-2xl flex flex-col overflow-hidden">
        ...
        <div
          onClick={openAuction}
          className="on-click-section cursor-pointer
        ...
        >
          ...
          <div className="pt-2 pr-2 pl-2 pb-1">
            ...
            <div className="flex flex-col items-start">
              <p className="text-color-primary font-bold font-medium text-16 leading-24">
                {currentPrice}€
              </p>
            </div>
          </div>
        ...
        {isOwner && isOver && (
          <div className="flex justify-between px-3 pb-1">
            ...
            <button
              className="text-gray-900 border border-black bg-white custom-button py-1 px-2 rounded-xl"
            ...
            >
              <svg
                className="bi bi-pencil h-4 w-4 mt-1 mr-1"
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
                fill="currentColor"

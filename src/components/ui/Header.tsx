      ...
      if (user && user.image) {
        try {
          ...
          const response = await fetch(
            `${process.env.REACT_APP_API_URL}/files/${user.image}`,
          );
        ...
        {user?.email ? (
          ...
          <>
            <div className="flex items-center">
              ...
              <div className="flex items-start bg-white rounded-full p-1">
                ...
                >
                  ...
                  <svg
                    className="w-4 h-4 inline-block mr-1 bi bi-house-door"
                ...
                >
                  {/* svg ikonca zraven teksta */}
                  <svg
                    className="w-4 h-4 inline-block mr-1 bi bi-person"
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                    fill="currentColor"
            ...
            <div className="flex items-end bg-white rounded-full pt-1 pl-1 pr-1">
              ...
              <button
                onClick={togglePopupAuction}
                className="mb-1 mr-1 rounded-full bg-white"
              >
                <Avatar size="48" round src={'/images/new.png'} alt="Image" />
              </button>
              ...
              {authStore.user && (
                ...
                <div className="relative">
                  ...
                  <button
                    ref={buttonRef}
                    onClick={togglePopup}
                    className="mb-1 rounded-full bg-white"
                  >
                    <Avatar
                      size="48"
                      round
          ...
          <>
            ...
            <div className="flex items-center">
              <Link to="/login" className="text-black font-bold mr-2">
                Log in
              </Link>
              <span className="text-black">or</span>
              <Link
                to="/signup"
                className="ml-2 bg-black px-4 py-2 rounded-2xl"
              >
                Sign up
              </Link>
            </div>
